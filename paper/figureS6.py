...
def main(args):
    ...
    figure_path = f'{os.environ.get("FIG_PATH")}/paper/5.0'
    ...
    dataset = ArithmeticDataset(path = path, summary = f'{dataset_path}/test_notransform.pkl', include = include, transform = no_transform)
    ...
    f.savefig(f'{figure_path}/figureS6.png', dpi = 600)
