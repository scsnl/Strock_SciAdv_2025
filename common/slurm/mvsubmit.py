...
def main(args):
    ...
    cmd = 'sbatch {} --wrap="mv {}"'.format(flags, ' '.join(args.f))
    os.system(cmd)
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description = 'submits mv to the SLURM queue on the Sherlock Cluster', formatter_class=argparse.RawTextHelpFormatter)
